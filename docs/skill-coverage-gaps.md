...
### 3.2 心情偏差（7 条，已记入 inbox）

见 `docs/inbox.md`「中枢心情建模补充」条目。已完成：歌蕾蒂娅潮汐守望（`_gladiia_aegir_delta`, commit `dd0b377`）。
...
贸易站     117    116      1       0     1 条心情P1 已接入
控制中枢    95     61     26       8     1 条 Mujica + 7 条心情偏差
发电站      48     45      1       2     2 条爬升增量
会客室      87     65     17       5     17 条线索(故意排除)+5 条条件型
办公室      46     33      9       4     12 条心情P1 + 9 条线索
───────────────────────────────────────────────────────────────
合计       536    455     54      27    (产值相关)
```
