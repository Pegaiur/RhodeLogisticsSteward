...
from steward_core.synergy import control_per_operator_bonus, operator_estimated_efficiency
    ...
    for _round in range(params.local_search_max_rounds):
        ...
        for i, assignment in enumerate(best_plan.assignments):
            ...
            sorted_candidates = sorted(
                candidates,
                key=lambda op: -operator_estimated_efficiency(op, room_type, product),
            )
